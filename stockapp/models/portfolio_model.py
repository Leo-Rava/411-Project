...
class PortfolioModel:
    ...
    For calculating current total value, the 'fight' functions are most similar as well. 

    """

    def __init__(self):
        """Initializes the Portfolio with an empty list of stocks.

        The portfolio is initially empty, and the stock cache and time-to-live (TTL) caches are also initialized.
    ...
    def add_song_to_playlist(self, song_id: int) -> None:
        # can repurpose this fun into buying stock
    ...
    def remove_song_by_song_id(self, song_id: int) -> None:
        # can repurpose into selling stock
